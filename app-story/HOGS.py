...
if True:
    ...
    data_path = os.path.join(current_dir, '..', 'data', 's2v_reddit_2019_lg')

    # Load the Sense2Vec model using the relative path
    s2v = Sense2Vec().from_disk(data_path)
    # s2v = Sense2Vec().from_disk("C:/Users/user/Documents/Python-Me/Sense2Vec/s2v_reddit_2019_lg/")
    # s2v = Sense2Vec().from_disk("D:/2023Fall/FYP/Sense2Vec/s2v_reddit_2019_lg/")
    # assert query in s2v
...
def MultiDiGraphMatcher(target_graph, souce_graph):
    ...
    (target_graph, souce_graph, False)
